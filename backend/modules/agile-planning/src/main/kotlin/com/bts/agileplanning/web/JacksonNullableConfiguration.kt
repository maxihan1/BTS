// JsonNullable<T> 직렬화 모듈을 Spring Jackson 컨텍스트에 등록하는 설정 — agile-planning BC
 ...
 * Bean 을 ObjectMapper 에 자동 등록하므로, 이 Bean 으로 [org.openapitools.jackson.nullable.JsonNullable]
 * 의 presence(undefined vs null) 역직렬화가 활성화된다.
 *
 * UpdateSprintRequest 의 name/goal/startDate/endDate 3-state(무변경/클리어/설정) 구분에 필요하다.
