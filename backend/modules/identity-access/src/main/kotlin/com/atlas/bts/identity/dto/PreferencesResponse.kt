 ...
 *
 * [UserPreferences][com.atlas.bts.identity.preferences.UserPreferences] 의 4개 필드를 그대로 노출한다
 ...
 * @property startPage 로그인 후 시작 페이지(`dashboards`/`my_issues`/`issues`/`inbox` 중 하나, FR-PF-02).
 */
