...
/**
 * 워크플로우 전환(Transition) 실행 중 Validator 와 PostAction 이 공유하는 읽기 전용 컨텍스트.
 *
 ...
 *
 * @param request 원본 전환 요청 DTO (호출자 BC 가 제공).
 * @param workflow 현재 적용 중인 워크플로우 aggregate.
 * @param fromState 전환 출발 상태.
 * @param transition 실행되는 전환 정의.
