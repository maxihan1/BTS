 ...
 * 전환 단건 항목.
 *
 * 전환 동일성은 ([fromStateKey], [toStateKey]) 쌍으로 식별한다 (ADR 2026-05-28-workflow-transition-identity-policy).
 ...
 * @property key computed 전환 식별자 (`"${fromStateKey}__${toStateKey}"`). 예: `"open__in_progress"`
