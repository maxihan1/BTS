// issueKeys 목록을 받아 키별 가용 전환을 best-effort 조회하고 교집합을 반환하는 서비스
...
/**
 * 여러 이슈에 공통으로 적용 가능한 전환 목록을 조회하는 Application Service.
 *
 ...
 *
 * @param issueService 단일 이슈 가용 전환 조회 서비스
 */
@Service
class BulkAvailableTransitionsService(
    ...
    /**
     * issueKeys 목록의 공통 가용 전환을 계산한다.
     *
     * @param actor 요청 행위자
     * @param issueKeys 조회 대상 이슈 키 문자열 목록
     * @return 교집합 전환 목록과 조회 실패 키 목록을 담은 결과
     */
 ...
 *
 * @param transitions 모든 조회 성공 이슈에 공통으로 존재하는 가용 전환 목록
