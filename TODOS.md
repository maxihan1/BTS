...
## ⬜ apps/web — 다이어그램 엣지 라벨 셋이 한 자리에 겹쳐 못 읽는다 (신규 · 미착수 · T1)
...
## ⬜ apps/web — 다이어그램 노드 선택 표시가 hover 와 구분되지 않는다 (신규 · 미착수 · T1)
...
## ⬜ apps/web — 다이어그램 self-loop 가 다른 노드를 관통하고 라벨이 캔버스 밖으로 달아난다 (신규 · 미착수 · T1)
