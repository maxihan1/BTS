...
2026-08-09 에 5회 미재현에도 ⬜ 를 유지한 이유가 그것이다. 대신 위 실측이 특정한
...
## ⬜ apps/web — 이동 대상 프로젝트 키 **대소문자 정규화 부재** (선재 · 미착수)
...
## ⬜ apps/web — 이동 `errorProjectNotFound` 도 **prod 도달 불가** 문구다 (선재 · 미착수)
...
## ⬜ apps/web — 이동 `errorPreview` 가 500·단절에도 「키를 확인해 주세요」라 말한다 (선재 · 미착수)
...
## ⬜ apps/web — 이동 403 문구에서 「다른 대상 프로젝트를 시도」가 함께 사라졌다 (신규 · 미착수 · **Maxi 확정으로 보류**)
