...
## ⬜ project-workflow — 프레임워크 예외 3종이 도메인 에러 봉투 밖으로 샌다 (선재 · 미착수 · T2)
...
## ⬜ project-workflow — `ValidatorResponse` 에 편집 가능 여부가 없어 D6 가 목록을 손으로 든다 (신규 · 미착수 · T2)
...
## ⬜ project-workflow — 편집 불가 조건이 코드는 허용 목록, 계약 문서는 `CustomExpression` 한 값 (신규 · 미착수 · T1)
