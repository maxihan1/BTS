...
- [x] D4. 백엔드 — Linking API + 재인증 강제 (책임. security-engineer) — **LDAP 연결+해제+목록+재인증(step-up) 완료(PR #103). SSO(SAML/OIDC) 연결 + SSO 재인증 완료(FR-AU-08b, PR #104) — 프론트(D6)·E2E(D7)는 후속** (PR #103, #104)
