...
| personalization | [product/personalization.md](product/personalization.md) | 21 (PR 4 + PF 3 + CA 2 + UX-01,04,05,06,07,08~14 12) | (없음) | ☐ D단계 (FR-UX-09 완주 · FR-UX-11 완주 · FR-UX-10 완주 · **FR-UX-12 완주(F4 #340 + F13 #341)** · UX-13~14 잔여) |
...
> `[ ]` **14** · `[~]` **0** · `[!]` **0**. 즉 139 FR 중 D 단계 미완은 **14 건**이며
> 전량 FR-UX-13~14(`product/personalization.md §4.11~§4.12`)의 D 단계다.
