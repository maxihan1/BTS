...
| personalization | [product/personalization.md](product/personalization.md) | 21 (PR 4 + PF 3 + CA 2 + UX-01,04,05,06,07,08~14 12) | (없음) | ☐ D단계 (FR-UX-09 완주 · FR-UX-10 은 F10 완료·F11 잔여 · UX-11~14 잔여) |
...
>
> 2026-08-03 재실측 — `grep -rhoE '^- \[x\] D[0-9]+\.' product/*.md | wc -l` → **935**,
> `[ ]` **30** · `[~]` **0** · `[!]` **0**. 즉 139 FR 중 D 단계 미완은 **30 건**이며
