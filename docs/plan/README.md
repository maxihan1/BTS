...
| issue-tracking | [product/issue-tracking.md](product/issue-tracking.md) | 37 (IS 10 + CM 4 + VR 4 + AC 2 + MN 2 + CO 2 + WT 1 + LK 2 + HS 2 + TM 2 + MV 2 + PJ 4) | (없음 — pgmq 이벤트 의존) | ☐ |
...
| personalization | [product/personalization.md](product/personalization.md) | 13 (PR 4 + PF 3 + CA 2 + UX-01,04,05,06 4) | (없음) | ☐ |
