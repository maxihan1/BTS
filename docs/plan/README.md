...
| personalization | [product/personalization.md](product/personalization.md) | 21 (PR 4 + PF 3 + CA 2 + UX-01,04,05,06,07,08~14 12) | (없음) | ☐ D단계 (FR-UX-09 완주 · **FR-UX-11 완주** · FR-UX-10 은 F10 완료·F11 잔여 · UX-12~14 잔여) |
...
>
> 2026-08-04 재실측 — `grep -rhoE '^- \[x\] D[0-9]+\.' product/*.md | wc -l` → **942**,
> `[ ]` **23** · `[~]` **0** · `[!]` **0**. 즉 139 FR 중 D 단계 미완은 **23 건**이며
> 전량 FR-UX-10 · 12~14(`product/personalization.md §4`)의 D 단계다 — FR-UX-09 는 2026-08-03 PR #333 으로 완주했고,
> **FR-UX-11 은 F8(PR #337) + F9(PR #338)로 D1~D7 전량 `[x]` 가 됐다**(2026-08-04 완주).
> **FR-UX-10 은 F10(PR #336)으로 D1~D5 를 닫았다**(D6/D7 은 F11 대기 — F11 의 선행 F8 은 이미 완료라 잔여는 F11 1건).
