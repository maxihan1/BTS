...
> 날짜. 2026-08-25
> 상태. **채택 (Active)** — 2026-08-26 게이트 2 에서 Maxi 가 인가했다. 근거 규칙이 「ADR + **Maxi 확인** 필수」라 ADR 단독으로는 요건이 닫히지 않았고, 그 확인이 들어와 닫혔다. (저장소 표기 관례가 「채택 (Active)」이라 예고했던 「Accepted」 대신 이 표기를 쓴다.)
