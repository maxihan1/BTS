...
/** ComponentLeadSelect props */
interface ComponentLeadSelectProps {
 ...
 */
export const ComponentLeadSelect = ({
  users,
  currentLead,
  onSearch,
  onChange,
  disabled = false,
}: ComponentLeadSelectProps): JSX.Element => {
  const { form } = componentLabels
