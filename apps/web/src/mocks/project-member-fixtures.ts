...
export const userDirectoryFixtures: UserDirectoryEntry[] = [
  makeUserEntry({ id: 'fixture-alice-uuid', username: 'alice', displayName: '앨리스', email: 'alice@example.com' }),
  makeUserEntry({ id: 'fixture-bob-uuid', username: 'bob', displayName: '밥', email: 'bob@example.com' }),
