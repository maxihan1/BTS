  ...
  columns: [
    {
      ...
      wipExceeded: false,
      cards: [
        { issueKey: 'ATLAS-1', summary: '카드 X', assigneeId: null, version: 1, priority: 1, epicKey: null, rank: null, typeKey: 'task', labels: [], originalEstimateSeconds: null },
        { issueKey: 'ATLAS-2', summary: '카드 Y', assigneeId: null, version: 1, priority: 1, epicKey: null, rank: null, typeKey: 'task', labels: [], originalEstimateSeconds: null },
      ],
    },
    {
      columnId: COL_B_ID,
