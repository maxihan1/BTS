 ...
 * Map<String, Boolean> 직렬화 → `{ "CREATE": ..., "MANAGE_COMPONENTS": ..., "MANAGE_VERSIONS": ..., "MANAGE_CUSTOM_FIELDS": ..., "MANAGE_FIELD_PERMISSIONS": ... }`.
 * 이 스키마의 각 키는 백엔드 enum 이름과 1:1 대응한다.
 *
 * MANAGE_COMPONENTS / MANAGE_VERSIONS / MANAGE_CUSTOM_FIELDS / MANAGE_FIELD_PERMISSIONS: PROJECT_ADMIN 전용. 일반 멤버/비멤버는 false.
 */
 ...
 * @returns ProjectPermissions — projectKey + CREATE/MANAGE_COMPONENTS/MANAGE_VERSIONS/MANAGE_CUSTOM_FIELDS/MANAGE_FIELD_PERMISSIONS 권한 맵
