...
**상태 (2026-08-02 재실측)**. 139 FR 중 **FR-UX-09~14 를 제외한 전량**의 D1~D7 단계 완료
(`- [x] D«n».` 926건 / 미완 39건 — 전량 FR-UX-09~14, `docs/plan/product/personalization.md §4`).
FR-UX-09 는 **D4/D5 백엔드(PR #328) → D2 명세 + D6/D7 의 F2 분(PR #331)** 순으로 닫혀 왔고,
**F3 진입점 3곳(보드 · 백로그 · 스프린트)이 남아 D6/D7 은 아직 `[ ]`** 다 — D 마커는 완주 단위다.
...
미완이 6건 → 49건으로 늘었다가 42건이 된 것은 회귀가 아니라 로드맵 잔여를 문서에 드러낸 결과다.
