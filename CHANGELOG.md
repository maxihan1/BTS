...
**상태 (2026-08-04 재실측)**. 139 FR 중 **FR-UX-10 · 12~14 를 제외한 전량**의 D1~D7 단계 완료
(`- [x] D«n».` 942건 / 미완 23건 — 전량 FR-UX-10 · 12~14, `docs/plan/product/personalization.md §4`).
...
FR-UX-10(컨텍스트 단축키)은 F10(PR #336)으로 D1~D5 를 닫았고 D6/D7 은 F11 을 기다린다.
