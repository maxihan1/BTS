...
**상태 (2026-08-03 재실측)**. 139 FR 중 **FR-UX-10~14 를 제외한 전량**의 D1~D7 단계 완료
(`- [x] D«n».` 940건 / 미완 25건 — 전량 FR-UX-10~14, `docs/plan/product/personalization.md §4`).
...
| personalization | 16 완료 / 21 등록 (PR 4 · UX 7 · PF 3 · CA 2 완료 + UX-10~14 5 미착수) | 2026-07-05 ~ 08-03 | 3 (#239~#333 외) | 프로필/환경설정 · 퀵 필터 · 캘린더 · FR-UX-06 Jira Cloud 방식 재설계(22 PR 체인) · FR-UX-07 활성 프로젝트 컨텍스트 · FR-UX-08 프로젝트 전환/최근 항목 · **FR-UX-09 이슈 생성 흐름(모달 + 진입점 5곳)** |
