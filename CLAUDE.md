...
**현재 단계**. **Phase 1 진행 중** (123 FR, 진척 현황은 `docs/plan/progress.html` / `docs/plan/README.md`). backend 7개 모듈(identity-access · issue-tracking · project-workflow · shared-kernel · agile-planning · notification-dashboard · search-export-import) + `apps/web` SPA 구현 중. SDD v0.5.0.
