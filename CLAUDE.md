...
**진척** — 144 FR 중 143 의 D 단계 완료 · FR-BD-04 완주(보드 종류·활성 스프린트 보드 — #421 스키마·백엔드 · #422 종류 선택 UI · #424 보드 화면·백로그 스코프·E2E) · FR-WF-04 완료(#400) · FR-WF-05 완료(#398) · FR-WF-06 완료(백엔드 #404 · UI #407) · FR-WF-07 진행중(초안·발행 백엔드 완료 · 이관 실행과 UI 는 후속). 정본 `docs/plan/README.md`.
