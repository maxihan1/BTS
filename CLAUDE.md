...
**현재 단계**. **Phase 1 진행 중** (129 FR, 진척 현황은 `docs/plan/progress.html` / `docs/plan/README.md`). backend 9개 모듈(identity-access · issue-tracking · project-workflow · shared-kernel · agile-planning · notification-dashboard · search-export-import · slack-integration · automation) + `apps/web` SPA 구현 중. SDD v0.5.0.
...
| 기능 구현 진척 / FR 추적 | `docs/plan/README.md` (BC별 product/*.md, 129 FR) |
