...
**진척** — **144 FR 전량 D 단계 완료**(2026-09-03 · #434 로 마지막 마커가 닫혔다) · FR-BD-04 완주(보드 종류·활성 스프린트 보드 — #421 스키마·백엔드 · #422 종류 선택 UI · #424 보드 화면·백로그 스코프·E2E) · FR-WF-04 완료(#400) · FR-WF-05 완료(#398) · FR-WF-06 완료(백엔드 #404 · UI #407) · FR-WF-07 완주(초안·발행 #411 · 이관 실행 #414·#417 · UI #423·#427 · 다이어그램 #434). **D 단계 0 은 BC 완료 선언이 아니다** — 9 BC 모두 미선언이고 §NFR 측정이 공통 관문이다. 정본 `docs/plan/README.md`.
